...
public class BruchAddition extends JFrame {
	...
	private JTextField eingabeZaehlerOhneKuerzen;
	private JTextField eingabeNennerOhneKuerzen;
	...
	int ergebnisZwischenZaehlerUngekuerzt;
	int ergebnisZaehler; 
	int ergebnisNenner;
	int aufgabenCounter;

	public BruchAddition() {
		setVisible(true);
		setResizable(false);
		...
		//Event mit dem CaretListener : überprüft ob die Eingabe im Textfeld richtig ist.
		//Wenn ja, wird der Hintergrund auf grün gesetzt, wenn nein auf rot.
		eingabeZaehlerOhneKuerzen = new JTextField();
		eingabeZaehlerOhneKuerzen.addCaretListener(new CaretListener() {
			public void caretUpdate(CaretEvent e) {
				String getZaehlerOhneKuerzen = eingabeZaehlerOhneKuerzen.getText();
				try{
					int parsedZaehlerOhneKuerzen = Integer.parseInt(getZaehlerOhneKuerzen);
					if (ergebnisZwischenZaehlerUngekuerzt  == parsedZaehlerOhneKuerzen) {
						eingabeZaehlerOhneKuerzen.setBackground(Color.GREEN);
					}
					else {
						eingabeZaehlerOhneKuerzen.setBackground(Color.RED);
					}
				}
				catch(NumberFormatException err){
				}
		...
		eingabeZaehlerOhneKuerzen.setBounds(20, 36, 25, 20);
		rightPanel.add(eingabeZaehlerOhneKuerzen);
		eingabeZaehlerOhneKuerzen.setColumns(10);
		...
		//Event mit dem CaretListener : überprüft ob die Eingabe im Textfeld richtig ist.
		//Wenn ja, wird der Hintergrund auf grün gesetzt, wenn nein auf rot.
		eingabeNennerOhneKuerzen = new JTextField();
		eingabeNennerOhneKuerzen.addCaretListener(new CaretListener() {
			public void caretUpdate(CaretEvent e) {
				String getZwischenNenner = eingabeNennerOhneKuerzen.getText();
				try{
					int parsedZwischenNenner = Integer.parseInt(getZwischenNenner);
					if (ergebnisZwischenNenner == parsedZwischenNenner) {
						eingabeNennerOhneKuerzen.setBackground(Color.GREEN);
					}
					else {
						eingabeNennerOhneKuerzen.setBackground(Color.RED);
					}
				}
				catch(NumberFormatException err){
				}
		...
		eingabeNennerOhneKuerzen.setColumns(10);
		eingabeNennerOhneKuerzen.setBounds(20, 94, 25, 20);
		rightPanel.add(eingabeNennerOhneKuerzen);
		...
		btnNeueAufgabe.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				eingabeZaehlerOhneKuerzen.setText("");
				eingabeZaehlerOhneKuerzen.setBackground(Color.WHITE);
				eingabeNennerOhneKuerzen.setText("");
				eingabeNennerOhneKuerzen.setBackground(Color.WHITE);
	...
	public void ErstelleAufgabe() {
		...
		ergebnisZwischenZaehlerUngekuerzt = ergebnisZwischenZaehler1 + ergebnisZwischenZaehler2;
